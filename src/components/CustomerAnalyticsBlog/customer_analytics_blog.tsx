      ...
      <div className={classes.maincontent2}>
        <div className={classes.btndiv}>
          <div className={classes.col1}>
            <div className={classes.scrolldiv}>
              ...
              <h1 className={classes.text2}>
                ...
                suggestions, or Upsell and Cross Sell Strategies! Predictive
                models are incredibly useful to study customers’ past behavior,
                correlate this information with similar customers, and then
                identify potential service/product opportunities. Let’s design
                and deploy effective analytical models and techniques to
                maximize Upsell & Cross Sell opportunities for your
                organization!
              </h1>
              <List className={classes.list}>
                ...
                <ListItem>
                  Perform Acquisition Pattern Analysis to identify the logical
                  step for the customer in terms of product / service
                  acquisition based on the pattern of previous acquisitions and
                  on the pattern of other customers.
                </ListItem>
                <ListItem>
                  Conduct Collaborative Filtering focuses on making
                  recommendations based on the associations between the product
                  recently purchased and others offered by the company.
                </ListItem>
                <ListItem>
              ...
              <h1 className={classes.text2}>
                ...
                DataFactZ is able to perform minute by minute advanced Market
                Basket analytics, enabling your organization to intelligently
                measure, monitor and model purchases to uncover insights at a
                faster rate, creating a unique ability to act upon what your
                shoppers are telling you in real-time.
              </h1>
              <List className={classes.list}>
                <ListItem>
                  Build a Recommendation Engine that can identify customer
                  buying behavior and their relationships.
                </ListItem>
                <ListItem>
              ...
              <h1 className={classes.text2}>
                At DataFactZ, Our experts can design and build robust
                Recommendation Engines, with advanced machine algorithms which
                give them the ability to predict consumer needs based on
                previous purchase history, online behavior, ratings, reviews and
              ...
              <List className={classes.list}>
                ...
                <ListItem>
                  Target the customers with the right offers that impeccably
                  timed.
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  These algorithms learns more about your customer and delivers
                  the most contextually relevant experience in real-time for
          ...
          <div className={classes.col2}>
            <img className={classes.image} src="images\Grupo.png"></img>
          </div>
        </div>
      </div>
