    ...
    <div className={classes.posts}>
      ...
      <div className={classes.content}>
        <p>
          ...
          triggering a wave of human and economic suffering, unlike anything
          that’s been experienced before. We need to take these moments as an
          opportunity…
        </p>
      </div>
      ...
      <div className={classes.content}>
        <p>
          ...
          focused first on delivery excellence, then evolve that into becoming a
          strategic Partner for our clients.&nbsp; This is ultimately our
          objective…
        </p>
      </div>
      <div className={classes.readmore}>
