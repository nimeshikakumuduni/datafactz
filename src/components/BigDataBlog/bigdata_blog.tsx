...
import useStyles from "./bigdata_blog_styles";
  ...
  return (
    <div className={classes.posts}>
      <div className={classes.maincontent2}>
        <img className={classes.image2} src="images\Screenshot (71).png"></img>
      </div>

      <div className={classes.maincontent1}>
        <div className={classes.content}>
          <h1 className={classes.ImageHeading}>Strategy</h1>
      ...
      <div className={classes.maincontent7}>
        ...
        <div className={classes.content}>
          <p className={classes.contentfont}>
            ...
            research around the program. We are developing a cognitive framework
            using Spark and Lamba Architecture. Organizations today are broadly
            adopting predictive analytics and building models ranging into the
            thousands. The ratio of models being utilized offline versus
            real-time is approximately 50 percent, and increasing rapidly. There
            are forecasts that soon, two-thirds of all predictive models will
            cater to real-time decision making such as fraudulent prevention,
            etc. This makes it increasingly more important to develop an
            architecture
          </p>
        </div>
        <div className={classes.content}>
          <p className={classes.contentfont}>
            ...
            implements a repeatable industrial-scale process for production, but
            the program is missing a component to visually represent model
            predictions. The third party apps that leverage Spark’s model of
            data processing introduce latency into the system. To overcome this,
            we designed a framework that seamlessly integrates with Spark. The
            framework leverages the reactive platform offered by Type Safe, the
            company behind
          </p>
        </div>
        ...
        <div className={classes.content}>
          <p className={classes.contentfont}>
            ...
            Play frameworks. Type safe Activator and Play frameworks, which are
            Scala-compliant, work effortlessly with Spark’s processing
            framework. The front-end visual architecture is plug-and-play. When
            used in conjunction with the most popular visualizations frameworks
            ranging from angular.js to D3, it increases the library of advanced
            visualizations. The whole framework exploits akka message-driven
            runtime and is entirely distributed and resilient with scalability
